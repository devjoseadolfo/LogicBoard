...
public class Or: Gate, Expandable {
    public var parentCircuit: Circuit?
    
    public var deviceName: String = "OR GATE"
    public var imageName: String = "OR"
    ...
    public func run() {
        outputs[0] = inputs.contains(true)
    }
}
