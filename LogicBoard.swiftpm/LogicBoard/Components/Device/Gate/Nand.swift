...
public class Nand: Gate, Expandable {
    public var parentCircuit: Circuit?
    
    public var deviceName: String = "NAND GATE"
    public var imageName: String = "NAND"
    ...
    public func run() {
        outputs[0] = inputs.contains(false)
    }
}
